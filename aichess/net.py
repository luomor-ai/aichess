...
class Net(nn.Layer):
    ...
    def __init__(self, num_channels=256, num_res_blocks=13):
        ...
        # 全局特征
        self.global_conv = nn.Conv2D(in_channels=num_channels, out_channels=512, kernel_size=(10, 9))
...
class PolicyValueNet:
    ...
    def __init__(self, model_file=None, opt_file=None, use_gpu=True):
        ...
        if opt_file:
            try:
                # 加载优化器参数
                opt_params = paddle.load(opt_file)
